...
public class PaymentTest {
    ...
    @DisplayName("Card - Purchase approved successfully")
    @Test
    ...
    @DisplayName("Card - Payment declined for card")
    @Test
    ...
    @DisplayName("Card - No input provided in fields")
    @Test
    ...
    @DisplayName("Card - Empty card number field")
    @Test
    ...
    @DisplayName("Card - Invalid card number format")
    @Test
    ...
    @DisplayName("Card - Invalid month entered")
    @Test
    ...
    @DisplayName("Card - Invalid year entered")
    @Test
    ...
    @DisplayName("Card - Invalid CVV format")
    @Test
